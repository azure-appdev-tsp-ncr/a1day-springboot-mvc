...
== Setup Notes:
Created Windows 10 Pro VM in Azure using a D-v3 Series (Nested Virtualization for Docker), Standard D4s v3 (4 vcpus, 16 GB memory).  Then used instructions here for Powershell install of dependencies 
